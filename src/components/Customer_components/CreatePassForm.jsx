...
function CreatePassForm() {
    return (
        <div className='container py-10 px-5 min-h-1/2 max-w-1/3' style={{ backgroundColor: '' }}>
            <p className='mb-12'>Create your new Password</p>
            ...
            <input type="password" placeholder="Password" className="w-full px-4 py-3 mb-3 rounded-md bg-gray-600 text-white placeholder-white" />
            <input type="text" placeholder="Confirm Password" className="w-full px-4 py-3 mb-3 rounded-md bg-gray-600 text-white placeholder-white" />
