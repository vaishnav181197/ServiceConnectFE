...
function AlertModal({ content, pay, title, service }) {
    return (
        <>
            <div className='container bg-gray-100 shadow flex flex-col justify-around items-center p-4 w-fit min-h-1/2  border-3 border-black rounded-xl '>
                ...
                }
                {
                    ...
                    <div className='w-full flex justify-around my-3'>
                        ...
                        <button class="w-full mx-auto shadow-2xl bg-black hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-full">
                            Write a Review
                            <span className='p-1 bg-white rounded-full ml-10'>
                                <i className="fa-solid fa-arrow-right text-black"></i>
                            </span>
